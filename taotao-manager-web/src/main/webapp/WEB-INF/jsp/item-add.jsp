...
<link type="text/css" rel="stylesheet" href="/js/kindeditor-4.1.10/themes/default/default.css"/>
    ...
    <form id="itemAddForm" class="itemForm" method="post">
        <table cellpadding="5">
            ...
            <tr>
                <td>商品标题:</td>
                <td>
                    <input class="easyui-textbox" type="text" name="title" data-options="required:true" style="width:
                     280px;"/>
                </td>
            </tr>
            <tr>
                <td>商品卖点:</td>
                <td>
                    <input class="easyui-textbox" name="sellPoint"
                           data-options="multiline:true,validType:'length[0,150]'" style="height: 60px;width: 280px;"/>
                </td>
            </tr>
            <tr>
                <td>商品价格:</td>
